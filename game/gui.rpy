...
define gui.choice_button_width = 632
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(80, 4, 80, 4)
...
define gui.slot_button_width = 221
...
define config.thumbnail_width = 205
define config.thumbnail_height = 116
...
define gui.skip_frame_borders = Borders(13, 4, 40, 4)

## Marco usado en la pantalla de notificación.
define gui.notify_frame_borders = Borders(13, 4, 32, 4)
...
define gui.history_height = 112

## Posición, anchura y alineación de la etiqueta con el nombre del personaje
## hablante.
define gui.history_name_xpos = 124
define gui.history_name_ypos = 0
define gui.history_name_width = 124
define gui.history_name_xalign = 1.0

## Posición, anchura y alineación del texto del diálogo.
define gui.history_text_xpos = 136
define gui.history_text_ypos = 2
define gui.history_text_width = 592
...
define gui.nvl_borders = Borders(0, 8, 0, 16)
...
init python:
    ...
    def small():
        ...
        gui.choice_button_text_size = 24
